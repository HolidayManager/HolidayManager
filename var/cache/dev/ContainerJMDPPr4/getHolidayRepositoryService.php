...
// Returns the private 'App\Repository\HolidayRepository' shared autowired service.
...
include_once $this->targetDirs[3].'/src/Repository/HolidayRepository.php';

return $this->privates['App\Repository\HolidayRepository'] = new \App\Repository\HolidayRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
